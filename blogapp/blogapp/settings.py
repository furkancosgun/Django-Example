...
SECRET_KEY = 'django-insecure-vfz6dgiroo!3_8+mha0qpyil74-m2o926y))4vt@)okcw5l6ez'
...
TEMPLATES = [
    {
        ...
        'DIRS': [
            BASE_DIR / "templates"#şeklinde ana dizinde bulunan templates klasörü projeye tanıtılır
        ],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
